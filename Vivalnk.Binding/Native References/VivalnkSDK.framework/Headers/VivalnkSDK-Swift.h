...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VivalnkSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CBUUID;
enum VVDFUUuidType : NSInteger;

/// DFU UUID object.
SWIFT_CLASS("_TtC10VivalnkSDK7DFUUuid")
@interface DFUUuid : NSObject
/// UUID For the DFU UUID Object.
@property (nonatomic, readonly, strong) CBUUID * _Nonnull uuid;
/// Type of DFU UUID.
@property (nonatomic, readonly) enum VVDFUUuidType type;
- (nonnull instancetype)initWithUUID:(CBUUID * _Nonnull)withUUID forType:(enum VVDFUUuidType)forType OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM(NSInteger, VVDFUError, closed) {
  VVDFUErrorRemoteLegacyDFUSuccess = 1,
  VVDFUErrorRemoteLegacyDFUInvalidState = 2,
  VVDFUErrorRemoteLegacyDFUNotSupported = 3,
  VVDFUErrorRemoteLegacyDFUDataExceedsLimit = 4,
  VVDFUErrorRemoteLegacyDFUCrcError = 5,
  VVDFUErrorRemoteLegacyDFUOperationFailed = 6,
  VVDFUErrorRemoteSecureDFUSuccess = 11,
  VVDFUErrorRemoteSecureDFUOpCodeNotSupported = 12,
  VVDFUErrorRemoteSecureDFUInvalidParameter = 13,
  VVDFUErrorRemoteSecureDFUInsufficientResources = 14,
  VVDFUErrorRemoteSecureDFUInvalidObject = 15,
  VVDFUErrorRemoteSecureDFUSignatureMismatch = 16,
  VVDFUErrorRemoteSecureDFUUnsupportedType = 17,
  VVDFUErrorRemoteSecureDFUOperationNotPermitted = 18,
  VVDFUErrorRemoteSecureDFUOperationFailed = 20,
  VVDFUErrorRemoteSecureDFUExtendedError = 21,
  VVDFUErrorRemoteExtendedErrorWrongCommandFormat = 22,
  VVDFUErrorRemoteExtendedErrorUnknownCommand = 23,
  VVDFUErrorRemoteExtendedErrorInitCommandInvalid = 24,
  VVDFUErrorRemoteExtendedErrorFwVersionFailure = 25,
  VVDFUErrorRemoteExtendedErrorHwVersionFailure = 26,
  VVDFUErrorRemoteExtendedErrorSdVersionFailure = 27,
  VVDFUErrorRemoteExtendedErrorSignatureMissing = 28,
  VVDFUErrorRemoteExtendedErrorWrongHashType = 29,
  VVDFUErrorRemoteExtendedErrorHashFailed = 30,
  VVDFUErrorRemoteExtendedErrorWrongSignatureType = 31,
  VVDFUErrorRemoteExtendedErrorVerificationFailed = 32,
  VVDFUErrorRemoteExtendedErrorInsufficientSpace = 33,
  VVDFUErrorRemoteExperimentalButtonlessDFUSuccess = 9001,
  VVDFUErrorRemoteExperimentalButtonlessDFUOpCodeNotSupported = 9002,
  VVDFUErrorRemoteExperimentalButtonlessDFUOperationFailed = 9004,
  VVDFUErrorRemoteButtonlessDFUSuccess = 91,
  VVDFUErrorRemoteButtonlessDFUOpCodeNotSupported = 92,
  VVDFUErrorRemoteButtonlessDFUOperationFailed = 94,
/// Providing the DFUFirmware is required.
  VVDFUErrorFileNotSpecified = 101,
/// Given firmware file is not supported.
  VVDFUErrorFileInvalid = 102,
...
/// http://infocenter.nordicsemi.com/topic/com.nordic.infocenter.sdk5.v11.0.0/bledfu_example_init.html?cp=4_0_0_4_2_1_1_3
  VVDFUErrorExtendedInitPacketRequired = 103,
...
/// bytes of the init packet are the firmware CRC).
  VVDFUErrorInitPacketRequired = 104,
  VVDFUErrorFailedToConnect = 201,
  VVDFUErrorDeviceDisconnected = 202,
  VVDFUErrorBluetoothDisabled = 203,
  VVDFUErrorServiceDiscoveryFailed = 301,
  VVDFUErrorDeviceNotSupported = 302,
  VVDFUErrorReadingVersionFailed = 303,
  VVDFUErrorEnablingControlPointFailed = 304,
  VVDFUErrorWritingCharacteristicFailed = 305,
  VVDFUErrorReceivingNotificationFailed = 306,
  VVDFUErrorUnsupportedResponse = 307,
...
/// number of bytes confirmed in Packet Receipt Notification.
  VVDFUErrorBytesLost = 308,
/// Error raised when the CRC reported by the remote device does not match.
/// Service has done 3 attempts to send the data.
  VVDFUErrorCrcError = 309,
};

@class VVDFUFirmwareSize;
enum VVDFUFirmwareType : uint8_t;

/// The VVDFUFirmware object wraps the firmware file.
SWIFT_CLASS("_TtC10VivalnkSDK13VVDFUFirmware")
...
@property (nonatomic, readonly, strong) VVDFUFirmwareSize * _Nonnull size;
...
/// returns:
/// The DFU firmware object or <code>nil</code> in case of an error.
- (nullable instancetype)initWithUrlToZipFile:(NSURL * _Nonnull)urlToZipFile type:(enum VVDFUFirmwareType)type OBJC_DESIGNATED_INITIALIZER;
/// Creates the DFU Firmware object from a Distribution packet (ZIP).
/// Such file must contain a manifest.json file with firmware metadata and at
/// least one firmware binaries. Read more about the Distribution packet on
/// the DFU documentation.
...
/// returns:
/// The DFU firmware object or <code>nil</code> in case of an error.
- (nullable instancetype)initWithZipFile:(NSData * _Nonnull)zipFile type:(enum VVDFUFirmwareType)type OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// The DFU firmware object or <code>nil</code> in case of an error.
- (nullable instancetype)initWithUrlToBinOrHexFile:(NSURL * _Nonnull)urlToBinOrHexFile urlToDatFile:(NSURL * _Nullable)urlToDatFile type:(enum VVDFUFirmwareType)type OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// The DFU firmware object or <code>nil</code> in case of an error.
- (nullable instancetype)initWithBinFile:(NSData * _Nonnull)binFile datFile:(NSData * _Nullable)datFile type:(enum VVDFUFirmwareType)type OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// The DFU firmware object or <code>nil</code> in case of an error.
- (nullable instancetype)initWithHexFile:(NSData * _Nonnull)hexFile datFile:(NSData * _Nullable)datFile type:(enum VVDFUFirmwareType)type OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC10VivalnkSDK17VVDFUFirmwareSize")
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(uint8_t, VVDFUFirmwareType, closed) {
  VVDFUFirmwareTypeSoftdevice = 1,
  VVDFUFirmwareTypeBootloader = 2,
  VVDFUFirmwareTypeApplication = 4,
  VVDFUFirmwareTypeSoftdeviceBootloader = 3,
  VVDFUFirmwareTypeSoftdeviceBootloaderApplication = 7,
};
...
SWIFT_PROTOCOL("_TtP10VivalnkSDK31VVDFUPeripheralSelectorDelegate_")
...
SWIFT_CLASS("_TtC10VivalnkSDK23VVDFUPeripheralSelector")
...
/// Uploading state.
SWIFT_PROTOCOL("_TtP10VivalnkSDK21VVDFUProgressDelegate_")
...
SWIFT_CLASS("_TtC10VivalnkSDK22VVDFUServiceController")
...
enum VVDFUState : NSInteger;

/// The service delegate reports about state changes and errors.
SWIFT_PROTOCOL("_TtP10VivalnkSDK20VVDFUServiceDelegate_")
...
///
- (void)dfuStateDidChangeTo:(enum VVDFUState)state;
...
///
- (void)dfuError:(enum VVDFUError)error didOccurWithMessage:(NSString * _Nonnull)message;
@end

@protocol VVLoggerDelegate;
@class VVDFUUuidHelper;
...
SWIFT_CLASS("_TtC10VivalnkSDK21VVDFUServiceInitiator")
...
/// It is optional.
@property (nonatomic, weak) id <VVLoggerDelegate> _Nullable logger;
...
/// file.
@property (nonatomic, strong) id <VVDFUPeripheralSelectorDelegate> _Nonnull peripheralSelector;
...
- (VVDFUServiceInitiator * _Nonnull)withFirmware:(VVDFUFirmware * _Nonnull)file SWIFT_WARN_UNUSED_RESULT;
...
- (VVDFUServiceController * _Nullable)start SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("Use start(target: CBPeripheral) instead.");
...
- (VVDFUServiceController * _Nullable)startWithTarget:(CBPeripheral * _Nonnull)target SWIFT_WARN_UNUSED_RESULT;
...
/// could not be retrieved.
- (VVDFUServiceController * _Nullable)startWithTargetWithIdentifier:(NSUUID * _Nonnull)uuid SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, VVDFUState, closed) {
  VVDFUStateConnecting = 0,
  VVDFUStateStarting = 1,
  VVDFUStateEnablingDfuMode = 2,
  VVDFUStateUploading = 3,
  VVDFUStateValidating = 4,
  VVDFUStateDisconnecting = 5,
  VVDFUStateCompleted = 6,
  VVDFUStateAborted = 7,
};
...
/// the Nordic devices.
SWIFT_CLASS("_TtC10VivalnkSDK15VVDFUUuidHelper")
...
/// UUID Types for DFU.
typedef SWIFT_ENUM(NSInteger, VVDFUUuidType, closed) {
/// Legacy DFU Service.
  VVDFUUuidTypeLegacyService = 0,
/// Legacy DFU Control Point Characteristic.
  VVDFUUuidTypeLegacyControlPoint = 1,
/// Legacy DFU Packet Characteristic.
  VVDFUUuidTypeLegacyPacket = 2,
/// Legacy DFU Version Characteristic.
  VVDFUUuidTypeLegacyVersion = 3,
/// Secure DFU Service.
  VVDFUUuidTypeSecureService = 4,
/// Secure DFU Control Characteristic.
  VVDFUUuidTypeSecureControl = 5,
/// Secure DFU Packet Characteristic.
  VVDFUUuidTypeSecurePacket = 6,
/// Buttonless DFU Service.
  VVDFUUuidTypeButtonlessService = 7,
/// Buttonless DFU Characteristic.
  VVDFUUuidTypeButtonlessCharacteristic = 8,
/// Buttonless DFU Without Bond Sharing Characterisitic.
  VVDFUUuidTypeButtonlessWithoutBondSharing = 9,
/// Buttonless DFU With Bond Sharing Characterisitic.
  VVDFUUuidTypeButtonlessWithBondSharing = 10,
};
...
/// be ignored.
SWIFT_CLASS("_TtC10VivalnkSDK23VVIntelHex2BinConverter")
...
SWIFT_CLASS("_TtC10VivalnkSDK27VVLegacyDFUServiceInitiator")
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, VVLogLevel, closed) {
  VVLogLevelDebug = 0,
  VVLogLevelVerbose = 1,
  VVLogLevelInfo = 5,
  VVLogLevelApplication = 10,
  VVLogLevelWarning = 15,
  VVLogLevelError = 20,
};


/// The Logger delegate.
SWIFT_PROTOCOL("_TtP10VivalnkSDK16VVLoggerDelegate_")
@protocol VVLoggerDelegate
...
///
- (void)logWith:(enum VVLogLevel)level message:(NSString * _Nonnull)message;
@end


SWIFT_CLASS("_TtC10VivalnkSDK27VVSecureDFUServiceInitiator")
